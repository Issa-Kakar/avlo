...
export const STROKE_CONFIG = {
  ...
  PEN_SIMPLIFICATION_TOLERANCE: getEnvNumber('PEN_SIMPLIFICATION_TOLERANCE', 0.0),
  HIGHLIGHTER_SIMPLIFICATION_TOLERANCE: getEnvNumber('HIGHLIGHTER_SIMPLIFICATION_TOLERANCE', 0.5),
  SIMPLIFICATION_TOLERANCE_MULTIPLIER: getEnvNumber('SIMPLIFICATION_TOLERANCE_MULTIPLIER', 0.0),
