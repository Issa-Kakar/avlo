...
export const ROOM_CONFIG = {
  ...
  ROOM_SIZE_WARNING_BYTES: getEnvNumber('ROOM_SIZE_WARNING_BYTES', 8 * 1024 * 1024), // 8 MB
  ROOM_SIZE_READONLY_BYTES: getEnvNumber('ROOM_SIZE_READONLY_BYTES', 10 * 1024 * 1024), // 10 MB
  // Capacity limits
...
export const STROKE_CONFIG = {
  ...
  // Update size limits
  MAX_ENCODED_UPDATE_BYTES: getEnvNumber('MAX_ENCODED_UPDATE_BYTES', 128 * 1024), // 128 KB
  // Opacity defaults
 ...
 */
export function calculateAwarenessInterval(peerCount) {
 ...
 */
export function applyJitter(value, jitterFactor) {
