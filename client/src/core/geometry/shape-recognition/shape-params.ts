...
export const CIRCLE_MAX_AXIS_RATIO = 1.7; // Maximum PCA axis ratio sqrt(λ₁/λ₂) for roundness
export const CIRCLE_MAX_RMS_RATIO = 0.24; // Maximum normalized RMS residual (RMS/radius)

// Circle Scoring Weights (must sum to 1.0)
export const CIRCLE_WEIGHT_COVERAGE = 0.5; // Dominant factor - how complete the arc is
export const CIRCLE_WEIGHT_FIT = 0.3; // Quality of fit to ideal circle
export const CIRCLE_WEIGHT_ROUND = 0.2; // Roundness based on PCA axis ratio
...
export const RECT_WEIGHT_SIDECOV = 0.2; // Secondary: side coverage (25%)
export const RECT_WEIGHT_CORNERS = 0.35; // Tertiary: corner quality - soft (15%)
export const RECT_WEIGHT_PARALLEL = 0.0; // Gentle parallel hint (10%)
export const RECT_WEIGHT_ORTHOGONAL = 0.0; // Gentle orthogonal hint (10%)
