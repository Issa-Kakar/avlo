/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ad503fda5b31f3d1886ea9fe5ac2bf05)
// Runtime types generated with workerd@1.20260801.1 2026-07-30 nodejs_compat
interface __BaseEnv_Env {
	...
	OAUTH_PKCE_SECRET: string;
	APP_ORIGIN: string;
	OAUTH_REDIRECT_URI: string;
	USERS: Service /* entrypoint UsersRpc from avlo-users */;
	IMAGES: Service /* entrypoint ImagesRpc from avlo-images */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "ANON_SECRET" | "GOOGLE_CLIENT_SECRET" | "OAUTH_PKCE_SECRET" | "APP_ORIGIN" | "OAUTH_REDIRECT_URI">> {}
}
