/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd7fe6cd18c1eb15abe3d8a2ad61a4e4)
// Runtime types generated with workerd@1.20260801.1 2026-07-30 nodejs_compat
interface __BaseEnv_Env {
	DOCS: R2Bucket;
	ROOM_VISITS: Queue;
	ROOM_META: Queue;
	rooms: DurableObjectNamespace<import("./src/index").AvloDO>;
	AUTH: Service /* entrypoint AuthRpc from avlo-auth */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AvloDO";
	}
