/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d9e66c54e85141edba069f7b2295b13f)
// Runtime types generated with workerd@1.20260630.1 2026-06-30 nodejs_compat
interface __BaseEnv_Env {
	IMAGES: R2Bucket;
	RL_AI: RateLimit;
	AI: Ai;
	AvloAiAgent: DurableObjectNamespace<import("./src/index").AvloAiAgent>;
	AI_QUOTA: DurableObjectNamespace<import("./src/index").AiQuota>;
	AUTH: Service /* entrypoint AuthRpc from avlo-auth */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AvloAiAgent" | "AiQuota";
	}
