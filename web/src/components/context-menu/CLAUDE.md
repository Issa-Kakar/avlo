...
| `LanguageDropdown` | (no props) | Self-subscribes to `selectedStyles.codeLanguage`. 7-item language picker. |
...
| `LanguageDropdown.tsx` | Self-subscribing code language picker (7 languages) |
