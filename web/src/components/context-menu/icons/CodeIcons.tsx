...
/** Line-numbers toggle — filled "1" / "2" digits on the left with two stroked lines on
 *  the right (top full-width, bottom shorter to suggest item 2 wraps less). 22×16 viewBox. */
export const IconCodeLines = (props: SvgProps) => (
  <svg viewBox="0 0 22 16" fill="currentColor" aria-hidden="true" {...props}>
    ...
    <line x1="8" y1="3.75" x2="21" y2="3.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    <line x1="8" y1="12.25" x2="16" y2="12.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
