...
- **Artifact integrity — every byte the runtime consumes is verified against
  ...
  lock sha and refuses the boot on drift (restage ⇒ recapture; the anchor P3
  snapshots key on). Documented residual: first-load-without-SW TOCTOU
